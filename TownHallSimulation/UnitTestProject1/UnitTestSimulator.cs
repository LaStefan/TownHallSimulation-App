...
namespace UnitTestProject1
{
    ...
    public class UnitTestSimulator
    {
        ...
        //    s1.AddressChangeCountersList.Clear();
        //    List<Counter> expect = new List<Counter>();
        //    Counter counter1 = new Counter(new Point(275, 180), Appointment.AddressChange,s1);
        //    Counter counter4 = new Counter(new Point(633, 132), Appointment.AddressChange,s1);
        //    Counter counter7 = new Counter(new Point(815, 260), Appointment.AddressChange,s1);
        //    Counter counter10 = new Counter(new Point(275, 260), Appointment.AddressChange,s1);
        //    expect.Add(counter1);
        //    expect.Add(counter4);
        //    expect.Add(counter7);
        //    expect.Add(counter10);
        //    CollectionAssert.AreEqual(expect, s.AddressChangeCountersList);
        //}
